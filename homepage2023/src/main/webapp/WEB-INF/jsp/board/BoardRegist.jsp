...
<meta name="viewport" content="width=device-width,initial-scale-1.0,minimun=scale=1.0,maximum-scale=1.0,user-scaleble=no" />
<title>수업용 게시판</title>
<script src="https://code.jquery.com/jquery-Latest.min.js"></script>
<script src="https://cdn.tiny.cloud/1/zzupz1yxnh4o22xppzlg40yxvxwdt66is0v4bma9k58s1jqi/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
$(function(){
    var plugins = [
    ...
    language: "ko_KR", //한글판으로 변경
        selector: '#boardCn', //class 선택자로 변경!
        height: 500,
        menubar: false,
        plugins: plugins,
...
<c:url var="_BASE_PARAM" value="">
	<c:param name="boardType" value="${boardType}" />
	 <c:if test="${not empty srarchVO.searchCondition}"><c:param name="searchCondition" value="${searchVO.searchCondition}" /></c:if>
 	 <c:if test="${not empty srarchVO.searchKeyword}"><c:param name="searchKeyword" value="${searchVO.searchKeyword}" /></c:if>
</c:url>
...
<c:choose>
 ...
 <div class="container">
	<div id="contents"> <!-- 첨부파일은 method -> 무조건 post, enctype="multipart/form-data" 이거 붙여줘야 함. -->
