					...
					<form action="/login/actionLogin.do" name="frmGnrlLogin" method="post" id="frmGnrlLogin" onsubmit="return checkGnrlLogin(this)">
						<fieldset>
							...
							<span>
								...
								<!-- placeholder -> value와 비슷하지만 value는 입력창에 클릭하면 사라짐 -->
							</span>
							<span>
								<!-- label 의 역할 -> input 설명, 클릭하면 input을 선택하는 보조역할 -->
...
$(document).ready(function() {
	//아이디 입력 창 포커스 설정, 처음 들어오면 여기에 집중하게 됨. 포커스 온.
	$('#id').focus();
});
...
//카카오 키 정보 입력
Kakao.init('a409407ef3786f1d216bd6970553be05');
